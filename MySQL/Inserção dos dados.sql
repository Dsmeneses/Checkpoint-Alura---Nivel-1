-- OBS: Utilizei a inserção manual, uma vez que a importação dos arquivos '.csv' via 'Table Data Import Wizard'
-- não importava os arquivos com a acentuação correta, tentei corrigir de diversas formas, porém achei melhor realizar
-- a inserção de forma manual.

-- Insert dos dados na tabela cliente

INSERT INTO clientes (id_cliente, Nome, email, estado, plano_assinatura) VALUES
...
-- Insert dos dados na tabela Vendas
INSERT INTO vendas (id_venda, data_venda, id_cliente, id_produto, produto, categoria, valor_venda, quantidade) VALUES
...
(81, '2023-03-29', 111, 1, 'Notebook Gamer', 'Eletrônicos', 2603.06, 1),
(82, '2023-01-31', 109, 12, 'Action Figure: Batman', 'Colecionáveis', 3515.32, 3),
(83, '2023-02-26', 118, 6, 'Mouse Gamer Sem Fio', 'Periféricos', 4485.8, 4),
(84, '2023-03-01', 127, 6, 'Mouse Gamer Sem Fio', 'Periféricos', 1553.11, 4),
(85, '2023-03-07', 135, 8, 'Livro: A Guerra dos Tronos', 'Livros', 2599.11, 1),
(86, '2023-03-05', 142, 7, 'Headset Surround 7.1', 'Áudio', 3853.96, 1),
(87, '2023-03-17', 116, 10, 'Mesa Digitalizadora', 'Periféricos', 3935.51, 4),
(88, '2023-03-29', 128, 10, 'Mesa Digitalizadora', 'Periféricos', 2751.98, 3),
(89, '2023-03-03', 105, 7, 'Headset Surround 7.1', 'Áudio', 2771.67, 4),
(90, '2023-01-17', 106, 13, 'Caneca Star Wars', 'Decoração', 3816.47, 2),
(91, '2023-01-30', 124, 4, 'Monitor Ultrawide 34"', 'Periféricos', 208.2, 3),
(92, '2023-01-17', 105, 14, 'SSD NVMe 1TB', 'Componentes', 1149.19, 1),
(93, '2023-03-19', 134, 1, 'Notebook Gamer', 'Eletrônicos', 4692.68, 2),
(94, '2023-02-14', 113, 3, 'Cadeira Gamer Ergonômica', 'Móveis', 2211.13, 1),
(95, '2023-02-12', 133, 9, 'Webcam 4K', 'Periféricos', 332.56, 1),
(96, '2023-03-04', 124, 2, 'Smartphone Pro', 'Eletrônicos', 3527.63, 3),
(97, '2023-01-15', 149, 6, 'Mouse Gamer Sem Fio', 'Periféricos', 813.72, 3),
(98, '2023-01-17', 113, 9, 'Webcam 4K', 'Periféricos', 2580.22, 1),
(99, '2023-03-05', 101, 12, 'Action Figure: Batman', 'Colecionáveis', 2852.01, 2),
(100, '2023-02-02', 130, 7, 'Headset Surround 7.1', 'Áudio', 1753.49, 2),
